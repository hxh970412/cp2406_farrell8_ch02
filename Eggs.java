...
public class Eggs {
    ...
    {
        final int DOZEN = 12;
        final double PRICE_PER_DOZEN_DOZEN = 3.25;
        ...
        dozens = eggs / DOZEN;
        leftOver = eggs % DOZEN;
        total = dozens * PRICE_PER_DOZEN_DOZEN + leftOver * PRICE_PER_EGG;
        System.out.println("You ordered " + eggs + " eggs. That's " + dozens +
        " dozen at $" + PRICE_PER_EGG + " per dozen and " + leftOver + " loose eggs at " +
